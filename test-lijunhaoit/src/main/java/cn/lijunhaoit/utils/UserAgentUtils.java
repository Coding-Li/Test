...
//    public static SysLogDevice getDeviceInfoMore(String userAgent){
//        SysLogDevice sysLogDevice = new SysLogDevice();
//        sysLogDevice.setDeviceType(getDevicetype(userAgent));
//        sysLogDevice.setDeviceChannel(getOs(userAgent));
//        sysLogDevice.setDeviceInfo(getDeviceManufacturer(userAgent));
//        return sysLogDevice;
//    }
    /**
     * 根据http获取userAgent信息
...
//		String iosUserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16A366 QQ/7.7.8.421 V1_IPH_SQ_7.7.8_1_APP_A Pixel/750 Core/UIWebView Device/Apple(iPhone 6s) NetType/WIFI QBWebViewType/1";
        ...
        String otherUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.107 Safari/537.36";
...
//        System.out.println("args = " + getDeviceInfoMore(winUserAgent).toString());
    }
